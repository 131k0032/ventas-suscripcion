		...
		<div class="col-12 col-lg-4">
			...
			<figure class="p-2 p-sm-5 p-lg-4 p-xl-5 text-center">
				...
				<form class="" method="post">
					...
					<p class="text-center">¿Aún no tienes una cuenta? | <a href="<?php echo $ruta; ?>registro">Regístrate</a></p>
					
					<!-- <hr> -->

						<p class="text-center"><a href="#modalRecuperarPassword" data-toggle="modal" data-dismiss="modal">¿Olvidó su contraseña?</a></p>
