		...
		<div class="container p-0">
			...
			<div class="row">
				...
				<div class="col-7 col-sm-5 col-md-4 col-lg-2 col-xl-3 my-3 d-flex mt-lg-3 logotipo">
					...
					<a href="http://localhost/ventas-suscripcion/index.php?pagina=inicio">
				...
				<div class="col-5 col-sm-7 col-md-8 col-lg-2 col-xl-3 p-0 pt-4 pt-lg-2 mt-lg-1 pt-xl-4">
					...
					<div class="mr-2 mr-lg-0 float-right pt-1 ingresos">
						...
						<button class="btn btn-info btn-sm d-flex">
							...
							<a href="http://localhost/ventas-suscripcion/index.php?pagina=ingreso" class="text-white">Ingresar</a>

							<span class="text-white mx-2">|</span>

							<a href="http://localhost/ventas-suscripcion/index.php?pagina=registro" class="text-white">Crear Cuenta</a>
